...
$db->query = "insert into newsfeed_rep values(null, ".$no.", '".$_SESSION['id']."', '".$pass[1]."', '".date('Y-m-d')."', '".date('H:i:s')."', '".$content."')";
...
{
echo "<script>alert('댓글이 정상적으로 입력 되었습니다.');history.back()</script>";
}
$db->DBO();
}
