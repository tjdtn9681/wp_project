...
$db->DBI();
	...
	$db->query = "select no, id, date, time, content, image from newsfeed order by no desc limit ".$limit.", ".$onepage;
	...
	<form action='../writing.php' method='post' enctype='multipart/form-data'>
		...
		<div style='width:100%'><textarea placeholder='뉴스피드에 글을 남겨보세요.' style='width:100%;padding:5px' name='content' cols='90' rows='20'></textarea></div>
